...
public class CartController(ICartSessionService sessionService, IProductService productService, ICartService cartService) : Controller
{
    ...
    public IActionResult AddToCart(int productId)
    {
        ...
        TempData["message"] = string.Format("Your product ,{0} was added succeffully to cart", productToBeAdded.ProductName);
    ...
    public IActionResult Remove(int productId)
    {
        ...
        _sessionService.SetCart(cart);
        TempData["message"] = string.Format("Your product  was deleted succeffully from cart");
